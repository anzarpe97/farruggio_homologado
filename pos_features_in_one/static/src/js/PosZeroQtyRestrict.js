odoo.define('pos_features_in_one.PosZeroQtyRestrict', function(require) {
	"use strict";
	...
	const ResProductScreen = (ProductScreen) =>
		class extends ProductScreen {
			...
			async _onClickPay() {
				...
				let prod_used_qty = {};
				if(pos_config.pos_zero_qty_restrict){
	...
	Registries.Component.extend(ProductScreen, ResProductScreen);
