odoo.define('pos_features_in_one.PosBagButton', function(require) {
    "use strict";
    ...
    class PosBagButton extends PosComponent {
        ...
        async onClick() {
            ...
            let category = self.env.pos.config.pos_bag_category;
            if(category){
    ...
    ProductScreen.addControlButton({
        ...
        condition: function() {
            return this.env.pos.config.pos_bag_charges;
        },
    });
