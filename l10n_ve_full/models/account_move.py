...
class AccountMove(models.Model):
    ...
    nro_declaracion_aduana = fields.Char(string='Nro de Declaración de Aduana')
    fecha_declaracion_aduana = fields.Date(string='Fecha de Declaración de Aduana')
    ...
    affected_invoice = fields.Char(
        string='Factura Afectada', 
        size=64,
        help="Número de factura afectada (usada en Notas de Crédito/Débito creadas desde el diario)",
        tracking=True)
    ...
    is_public_company = fields.Boolean(
        string='Empresa pública',
        help='Marque este check si la factura corresponde a una empresa pública.'
    )
