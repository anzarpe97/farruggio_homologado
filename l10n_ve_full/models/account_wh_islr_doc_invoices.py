...
class AccountWhIslrDocInvoices(models.Model):
    ...
    def _get_nature(self, partner_id):
        ...
        # else:
        if acc_part_id.company_type == 'person' or acc_part_id.spn:
            return True
        else:
            return False
    ...
    def _get_xml_lines(self, ail_brw):
        ...
        if vendor:
            if vendor.company_type == 'company':
                ...
                if people_type == 'pjdo' or vendor.spn:
        ...
        return {
            ...
            'control_number': getattr(ail_brw.move_id, 'correlative', False) or ail_brw.move_id.nro_ctrl,
