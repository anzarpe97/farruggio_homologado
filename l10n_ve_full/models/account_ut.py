...
class AccountUT(models.Model):
    ...
    name = fields.Char(string='Número de Gaceta Oficial', size=64, required=True, readonly=False, default=None,
                       help="Número de Gaceta según la ley")
    date = fields.Date(string='Fecha de la Gaceta', required=True, help="Fecha en la que entra en vigor la nueva Unidad Tributaria Unitaria")
