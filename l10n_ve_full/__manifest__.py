# -*- coding: utf-8 -*-
{
    ...
    'version': '1.0.0',
    'depends': ['base', 'base_vat', 'base_address_extended', 'l10n_ve', 'contacts', 'account','account_accountant', 'account_debit_note', 'sale', 'purchase','stock', 'product','l10n_ve_invoice'],
    'data': [
        'data/res_state.xml',
        'data/res_city.xml',
        ...
        'views/account_wh_municipal.xml',
        ...
        'report/account_wh_municipal_report.xml',
        ...
        'data/account_wh_municipal_sequence.xml',
