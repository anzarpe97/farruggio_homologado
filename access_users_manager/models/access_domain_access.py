...
class DomainAccess(models.Model):
    ...
    access_model_name = fields.Char(related='access_model_id.model', string='Nombre del Modelo')
    access_create = fields.Boolean(string='Crear')
    access_read = fields.Boolean(string='Leer', default=True)
    access_write = fields.Boolean(string='Escritura')
    access_delete = fields.Boolean(string='Borrar')
    access_apply_domain = fields.Boolean(string='Aplicar Dominio')
    access_domain = fields.Text(string="Dominio", default='[]')
    access_user_manager_id = fields.Many2one('user.management', string='Administrar Reglas')
