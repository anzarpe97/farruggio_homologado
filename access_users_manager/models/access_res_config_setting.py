...
class GeneralSettings(models.TransientModel):
    ...
    password_expire_enable = fields.Boolean(string='Habilitar Expiración de Contraseña',
                                            config_parameter='access_users_manager.password_expire_enable')

    password_expire_in_days = fields.Integer(string='Día de expiración de Contraseña',
    ...
    def check_password_expire_in_days(self):
        ...
        if self.password_expire_enable and not self.password_expire_in_days:
            raise UserError(_('Por favor indique unos días para expirar mayor a cero...'))
