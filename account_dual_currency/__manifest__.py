# -*- coding: utf-8 -*-
{
    ...
    'company': 'Andres Castillo by Contables',
    'maintainer': 'Andres Castillo by Contables',
    ...
    'depends': [
                ...
                'account_reports_cash_basis', 'account_asset','product',
                ],
    'data':[
       #'data/fix_missing_tax_cron.xml',
