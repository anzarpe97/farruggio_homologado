...
class PosOrder(models.Model):
    ...
    order_in_hour = fields.Selection([('0', '00:00 - 00:59 hrs'),
                                      ...
                                      ('22', '22:00 - 22:59 hrs'),
                                      ('23', '23:00 - 23:59 hrs')
                                      ], compute="compute_order_date_time", store=True)
    ...
    def compute_order_date_time(self):
        for rec in self:
            ...
            if date_time:
                ...
                user_time_zone = pytz.timezone(self.env.user.partner_id.tz or self.env.user.tz or 'UTC')
...
class PosOrderReport(models.Model):
    ...
    def _select(self):
        return super(PosOrderReport, self)._select() + ',s.order_in_hour AS order_in_hour'

    def _group_by(self):
        return super(PosOrderReport, self)._group_by() + ',s.order_in_hour'
